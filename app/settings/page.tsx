            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-9 h-9 rounded-lg bg-cyan-50 flex items-center justify-center">
                  {isPublic ? (
                    <Eye className="w-4.5 h-4.5 text-cyan-600" />
                  ) : (
                    <EyeOff className="w-4.5 h-4.5 text-dark-400" />
                  )}
                </div>
                <div>
              ...
              <div className="flex items-center justify-between py-3 border-t border-dark-50">
                <div>
              ...
              {isPublic !== profile?.is_public && (
                <div className="flex items-center gap-3 mt-4">
                  <button
                    ...
                    disabled={saving}
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-teal-500 text-white text-sm font-bold hover:from-cyan-600 hover:to-teal-600 disabled:opacity-50 transition-all shadow-sm"
                  >
                    {saving ? (
                  ...
                  <button
                    onClick={() => setIsPublic(profile?.is_public ?? false)}
              ...
              {saveSuccess && (
                <div className="flex items-center gap-2 mt-3 text-sm text-emerald-600 font-medium animate-fadeInUp">
                  <Check className="w-4 h-4" />
