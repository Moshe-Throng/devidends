          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            ...
            {m.profile_id && (
              <div className="col-span-2 md:col-span-1">
                <div className="text-[10px] text-[#555] tracking-wider uppercase mb-1">CV file</div>
                <a
                  href={`/api/admin/cv-download?profile_id=${encodeURIComponent(m.profile_id)}`}
                  download
                  className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#27ABD2] hover:text-[#24CFD6] hover:underline"
                  title="Download this co-creator's CV"
                >
