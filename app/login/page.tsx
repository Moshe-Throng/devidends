      ...
      <main className="flex-1 flex items-center justify-center px-5 py-16">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl border border-dark-100 p-8 shadow-sm">
            {/* Telegram note */}
            {mode !== "forgot" && (
              <div className="mb-6 px-4 py-3 rounded-xl bg-cyan-50 border border-cyan-100 text-sm text-cyan-800">
                Using Telegram?{" "}
                <a
                ...
                — your Telegram login works automatically when you visit from there.
              </div>
            )}
